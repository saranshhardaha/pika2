  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto">
      <div className="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:p-0">
        ...
        <div className="relative inline-block w-full max-w-3xl p-6 my-8 text-left bg-neutral-900 rounded-lg shadow-xl transform transition-all sm:w-full">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div
              className={`border-2 border-dashed rounded-lg p-8 text-center ${
                isDragging ? 'border-blue-500 bg-neutral-800' : 'border-gray-700'
              }`}
              onDragOver={(e) => {
                e.preventDefault();
                setIsDragging(true);
            ...
            <div className="flex items-center space-x-2">
              ...
              <input
                ...
                className="flex-1 bg-neutral-800 border border-gray-700 rounded-lg px-4 py-2 text-white placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-transparent"
